...
class Lite3Cfg_Leggedstand(LeggedRobotCfg):
    """Lite3 leggedstand: stands on front legs (FL, FR), rear legs (HL, HR) airborne.

    Body x-axis points down in world frame at handstand pose
    ...
    class init_state(LeggedRobotCfg.init_state):
        ...
        # Leggedstand target: front legs (FL, FR) support, rear legs (HL, HR) tucked up.
        # NOTE: initial guess — needs visual calibration in MuJoCo viewer.
        descire_joint_angles = {
            # Front legs support (kept near default standing)
            'FL_HipX_joint': 0.0,  'FL_HipY_joint': -0.8, 'FL_Knee_joint': 1.6,
            'FR_HipX_joint': 0.0,  'FR_HipY_joint': -0.8, 'FR_Knee_joint': 1.6,
            # Rear legs tucked toward body (airborne when body inverted forward)
            'HL_HipX_joint': 0.0,  'HL_HipY_joint': -2.4, 'HL_Knee_joint': 2.5,
            'HR_HipX_joint': 0.0,  'HR_HipY_joint': -2.4, 'HR_Knee_joint': 2.5,
        }
    ...
    class asset:
        ...
        # Leggedstand: front legs (FL, FR) on ground, rear legs (HL, HR) in air.
        feet_name_reward = ['HL_FOOT', 'HR_FOOT']
    ...
    class rewards:
        ...
        soft_torque_limit = 1.
        # Front-legged stand height for Lite3 (~0.47 for Go2; Lite3 has shorter legs → lower)
...
class Lite3CfgPPO_Leggedstand(LeggedRobotCfgPPO):
    ...
    class runner:
        ...
        save_interval = 100
        experiment_name = 'lite3_leggedstand'
        run_name = ''
        resume = False
        load_run = -1
        checkpoint = -1
