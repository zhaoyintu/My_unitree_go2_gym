"""Unitree Go2 stairs environment configuration."""
...
def unitree_go2_stairs_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
    """Create Unitree Go2 stairs terrain configuration."""
    ...
    # Stairs terrain (trimesh with stairs proportions)
    ...
    # Rewards (same as trot)
    for rw in ("air_time", "body_ang_vel", "angular_momentum", "dof_pos_limits", "pose"):
    ...
    cfg.rewards["trot"] = RewardTermCfg(
        func=go2_mdp.trot_gait, weight=0.8,
    ...
    cfg.events["foot_friction_slide"] = EventTermCfg(
        ...
        params={
            ...
            "operation": "abs", "axes": [0], "ranges": (0.3, 1.5),
            "shared_random": True,
        },
    )
