...
class Lite3HandstandRLDeployStaticTest(unittest.TestCase):
    ...
    def test_reward_recipe_prioritizes_handstand_before_tracking(self) -> None:
        ...
        self.assertNotIn('"stance_sensor_name": "feet_ground_contact"', function_source)
        self.assertNotIn('"body_clearance_sensor_names": BODY_CLEARANCE_SENSOR_NAMES', function_source)
        ...
        self.assertNotIn('rewards["base_contact"].weight = -6.0', function_source)
        self.assertNotIn('rewards["thigh_collision"].weight = -4.0', function_source)
        self.assertNotIn('rewards["calf_collision"].weight = -4.0', function_source)
